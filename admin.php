    ...
    <section class="father-container-register-admin">
        <article class="information-container-register-admin">
            ...
            <ul class="li-container-register-admin">
                ...
                <li class="li-register-admin tablinks" onclick="openCategory(event, 'laptopsBtn')"><i class="uil uil-laptop"></i>Gaming Laptops</li>
                <li class="li-register-admin tablinks" onclick="openCategory(event, 'consolesBtn')"><i class="uil uil-play"></i>Gaming Consoles</li>
                ...
                <li class="li-register-admin tablinks" onclick="location.href='accessories.php'"><i class="uil uil-arrow-to-right"></i>Accessories</li>
